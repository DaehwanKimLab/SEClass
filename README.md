...
| Day 2: SA Search | Input .fa reference file (or input .sa from Day 1), and Multi-line query fasta file (labeled .qfa) | [abracadabra.fa](/Example_Files/abracadabra.fa) (or [abracadabra.sa](/Example_Files/abracadabra.sa)) and [abracadabra.qfa](/Example_Files/abracadabra.qfa)| A tab-delimited file where each row contains query name and alignment location, multiple rows for the same query matching multiple locations. | |
...
| Day 4: BWT Search | Input .bwt, input .sa | [abracadabra.bwt](/Example_Files/abracadabra.bwt) and [abracadabra.sa](/Example_Files/abracadabra.sa) | A tab-delimited file where each row contains query name and alignment location, multiple rows for the same query matching multiple locations. | | 
