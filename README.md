...
| Day 4: BWT Search | Input .bwt, input .sa | [abracadabra.bwt](/Example_Files/abracadabra.bwt) and [abracadabra.sa](/Example_Files/abracadabra.sa) | A tab-delimited file where each row contains query name and alignment location, multiple rows for the same query matching multiple locations. |[abracadabra.aln](/Example_Files/abracadabra.aln)  | 
